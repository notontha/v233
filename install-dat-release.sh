...
DOWNLOAD_LINK_GEOIP="https://github.notontha.workers.dev/v2ray/geoip/releases/latest/download/geoip.dat"
DOWNLOAD_LINK_GEOSITE="https://github.notontha.workers.dev/v2ray/domain-list-community/releases/latest/download/dlc.dat"
